...
function Header() {
  return (
    ...
    <div className='bg-brand-color'>
      ...
      <div className='container md:hidden mx-auto flex items-center h-10 p-3 justify-between shadow-sm '>
        <div className='flex items-center gap-x-2 text-sm font-semibold text-gray-700 '>
        <FaLocationDot size={18} className='text-primary-brand-color' /> Teslimat adresi belirle 
        </div>
        <div><IoIosArrowForward size={18} className='text-primary-brand-color' /></div>
      </div>
    </div>
  )
}
