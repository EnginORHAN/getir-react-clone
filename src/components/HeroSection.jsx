...
function HeroSection() {
  ...
  return (
    <div className='relative inset-0 overflow-hidden w-full mx-auto h-auto md:h-[500px] before:bg-gradient-to-r before:from-primary-brand-color before:to-transparent before:absolute before:inset-0 before:w-full before:h-full before:z-10' >
        ...
        <div className='md:container flex justify-between items-center relative md:absolute top-0 left-0 md:left-1/2 translate-x-0 md:-translate-x-1/2 h-full z-20'>
          ...
          <div className='grid gap-y-3'>
            ...
            />
              ...
              <input required className='h-12 px-4 border-2 border-gray-200 rounded w-full transition-colors hover:border-primary-brand-color outline-none focus:border-primary-brand-color peer text-sm pt-2' type='tel' maxLength={10}/>
            ...
            <button className='bg-brand-yellow h-12 flex items-center justify-center rounded-md w-full text-sm font-semibold text-primary-brand-color transition-colors hover:bg-primary-brand-color hover:text-brand-yellow'>Telefon numarası ile devam et</button>
          </div>
          </div>
        </div>
    </div>
